...
import { DialogFooter } from "../plate-ui/dialog";
...
export default function PlaygroundHeader({ id }: { id: string }) {
  ...
  const [submissionDialogOpen, setSubmissionDialogOpen] =
        ...
        <div className="flex gap-1">
          <div className="flex items-center divide-neutral-800 rounded-lg">
            ...
            {currentIndex >= problems.problemDetails.length - 1 ? (
              <Dialog open={submissionDialogOpen}>
                <DialogTrigger
              ...
              <Dialog open={dialogOpen}>
                ...
                <DialogContent>
                  <DialogHeader>
                    <DialogTitle>Proceed to next question?</DialogTitle>
                    <DialogDescription>
                  ...
                  <DialogFooter>
                    ...
                    <Button disabled={submittingCode} onClick={handleNext}>
                      {submittingCode ? (
                        <Loader2 className="animate-spin" />
                      ) : (
                        "Yes"
