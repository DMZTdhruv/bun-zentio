...
export function FontSizeToolbarButton() {
  ...
  return (
    <div className="flex h-7 items-center gap-1 rounded-md bg-neutral-800/50 p-0">
      ...
      <Popover open={isFocused} modal={false}>
        <PopoverTrigger asChild>
          <input
            className={cn(
              "h-full w-10 shrink-0 bg-transparent px-1 text-center text-sm hover:bg-neutral-800",
            )}
            value={displayValue}
            onBlur={() => {
              setIsFocused(false);
